...
//   const profileImage =
//     user?.image ||
//     `https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR_xFRooQh2XjRlx5Yw7nBBsvVF7ryFw0PPMK7fI5LFCrU0-Fj_7ZWjluM&s=${user?.firstName || "User"} ${user?.lastName || ""}`;
...
const Navbar = () => {
  ...
  "
              ...
              <Link
                to="/profile"
                title="Profile"
                className={`w-9 h-9 rounded-full border flex items-center justify-center overflow-hidden shrink-0 transition-colors duration-300 ${
                  isProfileActive
                    ? "border-white bg-[#1a1a1a]"
                    : "border-white/30 bg-[#1a1a1a] hover:border-[#3affa3]"
                }`}
              >
                {hasImage ? (
                  <img
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-2 pb-24">
            ...
            {token ? (
              <>
                ...
                >
                  <div className="w-9 h-9 rounded-full border border-dashed border-white/30 bg-[#1a1a1a] flex items-center justify-center overflow-hidden shrink-0">
                    {hasImage ? (
                      <img
                        src={user.image}
                        alt="Profile"
