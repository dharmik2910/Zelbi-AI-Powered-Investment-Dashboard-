...
//         const errorMsg = error.response?.data?.error || "Sorry, something went wrong while processing your request. Please try again.";
//         setMessages((prev) => [
//           ...prev,
//           {
//             type: "bot",
...
//         <div className="flex-1 overflow-y-scroll max-h-[470px] p-2 md:p-6 space-y-4">
...
//             >
//               <div
//                 className={`flex items-start space-x-3 max-w-[95%] md:max-w-[85%] ${message.type === "user" ? "flex-row-reverse space-x-reverse" : ""
//                   }`}
//               >
//                 <div
//                   className={`p-3 rounded-xl ${message.type === "user" ? "bg-[#1a1a1a]" : "bg-[#0a0a0a]"
//                     }`}
//                 >
//                   {message.type === "user" ? (
...
//                 </div>
//                 <div
//                   className={`p-4 rounded-xl ${message.type === "user" ? "bg-[#1a1a1a]" : "bg-[#0a0a0a]/50"
...
//     <div className="bg-[#111] border border-[#3affa3]/20 rounded-lg px-4 py-3 flex items-center justify-between">
//       <div className="flex items-center gap-3">
//         <FaRobot className="text-[#3affa3] text-xl" />
//         <div>
...
//       <button className="bg-[#3affa3] text-black text-sm font-semibold px-4 py-2 rounded-lg hover:bg-[#32e092]">
//         Upgrade
//       </button>
//     </div>
//   </div>
